## loading libraries
suppressWarnings(library(pROC)) # suppress warnings globally
library(randomForest) # Loads randomForest package 

RandomForestRegression_CV <- function(X_train,y,X_test=data.frame(),cv=5,ntree=50,nodesize=5,seed=123,metric="mae") #Defining Random forest function
{
